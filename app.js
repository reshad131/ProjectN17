...
function Info(nameStudent) {
    let student = Oxford.find(s => s.name.toLowerCase() === nameStudent.toLowerCase());
    if (student) {
        ...
        console.log("Student couldn't found!");
    }
}
...
let nameStudent = prompt("Enter the student's name:");
Info(nameStudent);